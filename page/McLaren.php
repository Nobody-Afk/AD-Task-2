...
<body>
    <div id="wrapper-div">
        ...
        <main>
            ...
            <p>The Papaya team is based from Woking, United Kingdom. With its entering since 1966 under the guidance and restless endeavour of its founder Bruce Mclaren. With current team principal Andrea Stella with CEO Zak Brown. Current WCC champions after snatching it from Redbull and Mercedes. This papaya team is currently a monster in the grid thanks to their engineers covering up something good during their pre-test during Bahrain last year.</p>
            <br />

            <p>McLaren's current drivers are No. 81 Oscar Piastri and the one bearing the number 4 Lando Norris, these two drivers are forced to be reckoned with. With Oscar leading the grid with exceptional 131 points, and Lando taking the second position with 115 points.</p>
            <br />
        </main>
        <footer>
